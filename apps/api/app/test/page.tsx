    ...
    <main className="mx-auto flex w-full max-w-xl flex-col gap-6 p-6">
      <div>
        ...
        <p className="text-sm text-neutral-500">
          Intern testsida på <code>/test</code>. Filips dashboard ligger på{" "}
          <a className="underline" href="/">
            /
          </a>
          . Logga in med <strong>samma konto som Claude</strong>. Listan hoppar fram
          direkt när Claude sparar, plus varannan sekund. Det senast ändrade minnet
          ligger överst i det gula kortet.
        </p>
      </div>
