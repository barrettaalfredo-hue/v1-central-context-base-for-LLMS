...
import { CLAUDE_INSTRUCTIONS, mcpUrl } from "@/lib/claude-instructions";
        ...
        <ol className="mt-6 flex flex-col gap-5">
          ...
          <Step n={2} title="Kopiera MCP-adressen">
            {url ? (
              ...
              <ErrorText message="MCP-adressen är inte satt. Sätt NEXT_PUBLIC_MCP_URL till Alfredos /api/mcp." />
            )}
          ...
          <Step n={4} title="Klistra in instruktionerna i Claude-projektet">
            ...
            <blockquote className="whitespace-pre-wrap rounded-md border border-line bg-background px-3 py-2 text-sm">
              {CLAUDE_INSTRUCTIONS}
            </blockquote>
            <div className="mt-2">
