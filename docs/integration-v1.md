...
**Inte** för daglig feature-kod. Hit mergas de tre person-grenarna. Här körs [torsdag-test.md](torsdag-test.md). **`main` rörs inte** förrän de fyra testerna är godkända.
