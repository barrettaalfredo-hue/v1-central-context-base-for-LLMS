...
**Leverans på den här branchen:** tre appar mot samma Supabase och samma `packages/memory`. Mock och stub av. Alla tester i [docs/torsdag-test.md](docs/torsdag-test.md) ska vara gröna.
